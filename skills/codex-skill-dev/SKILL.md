...
- 要求“参考 lark-cli-config 风格”“中文文档和交互”。
...
- 预检单个 skill：`python scripts/skill_preflight.py --repo-root . --skill <skill-name>`
- 同步 manifest：`python scripts/sync_manifest.py --repo-root . --skill <skill-name> --description "..." --tags a,b --requires python`
- 仓库级校验：`python scripts/validate_skill_repo.py --repo-root . --skill <skill-name>`
